...
=head1 SYNOPSIS
   ...
   my $layer = Net::Frame::ICMPv4::Information->new(
      identifier     => getRandom16bitsInt(),
      sequenceNumber => getRandom16bitsInt(),
      payload        => '',
   );
   ...
   # Read a raw layer
   my $layer = Net::Frame::ICMPv4::Information->new(raw => $raw);
...
This modules implements the encoding and decoding of the ICMPv4 Information object.
